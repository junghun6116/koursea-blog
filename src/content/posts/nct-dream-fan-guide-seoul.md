---
title: "NCT DREAM Fan Guide to Seoul: NCTzen Stops & Concert History"
description: "A practical NCT DREAM fan guide to Seoul: the shared KWANGYA@SEOUL retail stop, the group's Gocheok Sky Dome and KSPO DOME concert history, and what's still unconfirmed beyond it."
pubDate: 2026-09-22
updatedDate: 2026-09-22
category: "K-Pop & Concerts"
tags: ["nct dream", "nctzen", "kwangya seoul", "kspo dome", "sm entertainment", "kpop concert tickets"]
canonicalUrl: "https://blog.koursea.com/posts/nct-dream-fan-guide-seoul/"
...
KWANGYA@SEOUL, at B1, D Tower, Acro Seoul Forest, 83-21 Wangsimni-ro, Seongdong-gu, is SM Entertainment's shared official retail space and carries merchandise for the label's artists, including NCT DREAM. Because our NCT 127 and RIIZE guides already document the walking directions, store layout, and access notes for this exact address, this guide links to them instead of publishing a second description of the same venue. A duplicate listing would only make directions less reliable, not more useful.

SMTOWN Coex Artium is a separate point worth repeating on its own: it closed completely in 2020 and is not an operating SM visitor destination. Any post, video, or map pin that still treats Coex as a current SMTOWN stop is out of date.

## NCT DREAM's Seoul Concert History: Gocheok Sky Dome, Then KSPO DOME
...
## What's Confirmed Beyond the March 2026 Finale — and What Isn't

Beyond the March 2026 KSPO DOME finale, we could not confirm a new NCT DREAM Seoul concert date, venue, or ticketing window through the official channels checked for this guide. That is a statement about the limits of this check, not a confirmed absence of plans — we were not able to review every official SM or NCT DREAM channel. Separately, SM's wider NCT collective has reported group-wide 10th-anniversary plans (album release, world tours, exhibition) through entertainment press, which confirms NCT-wide activity but not an NCT DREAM-specific Seoul date beyond the finale above.

If you're planning a trip around a possible new NCT DREAM date, don't book travel or tickets around an unconfirmed show. Watch NCT DREAM's official Weverse and SM's own channels, and use our ticketing guide once a real sale is announced.

## Concert Preparation for a Future Show

For NCT DREAM specifically, the presale gate is the **"NCTzen DREAM" (GL) membership** on Weverse — register for it ahead of a sale, since the general NCTzen fandom name alone does not grant presale access. Beyond that, expect the same general pattern documented in our NCT 127 and RIIZE guides: a fan-club presale first, identity verification tied to your ticket-platform account, and a general sale afterward. Confirm the seller, membership registration deadline, account-name-to-passport matching, and pickup or mobile-ticket format from that show's own notice — don't assume the March 2026 finale's process repeats exactly for a different show.

Our [K-Pop concert ticketing guide](/posts/kpop-concert-ticketing-seoul-2026/) covers NOL World, Melon Ticket, Yes24, the Korean phone-number verification step, and ticket pickup mechanics without assuming one platform's rules apply to every show.
